            ...
            <div className="mx-auto grid max-w-4xl items-center gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl font-headline">
                  Never lose a movie recommendation again.
                </h1>
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  Tired of screenshot clutter? CineCapture analyzes your screengrabs, extracts movie details, and builds your personal watchlist automatically.
                </p>
              </div>
